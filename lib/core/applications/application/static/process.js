module.exports = require('async')(function* (resolve, reject, resource, application, runtime, language) {
    ...
    if (resource.contentType === 'text/html' && ['index.html', 'index.htm'].indexOf(filename) !== -1) {
        ...
        let hosts = {};
        hosts.application = config.application.hosts.js;
        hosts.beyond = config.libraries.beyond.hosts.js;
        hosts.vendor = config.libraries.vendor.hosts.js;
        hosts.ui = config.libraries.ui.hosts.js;
        ...
        head += '<!-- beyond.js -->\n';
        head += `<script defer src="${hosts.beyond + 'core/code.js'}"></script>\n\n`;
