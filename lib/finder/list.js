 ...
 * @param {string} {function} search - The file name or the function to check if the file matches the search
 */
let list = async(function* (resolve, reject, root, path, specs) {
    "use strict";
